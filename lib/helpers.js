...
export function generateSlots(
  ...
  if (!date || !availStartTime || !availEndTime) return [];
  ...
  // If end time is before or equal to start time, it spans past midnight into the next day
  ...
  while (isBefore(cursor, end)) {
    ...
    // Only push future slots (slots whose end time is after now)
