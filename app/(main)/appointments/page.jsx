...
const Appointments = async () => {
  ...
  return (
    <main className={"min-h-screen bg-black"}>
      ...
      <div
        className={"max-w-6xl mx-auto px-8 lg:px-0 py-8 flex flex-col gap-14"}
      >
        {appointments.length === 0 && (
          <div
            className={
              "flex flex-col items-center justify-center py-28 gap-5 text-center"
            }
          >
            <span
              className={
                "w-16 h-16 rounded-2xl bg-amber-400/10 border border-amber-400/20 flex items-center justify-center text-3xl"
              }
            >
        ...
        {scheduled.length > 0 && (
          <div className={"flex flex-col gap-5"}>
            <div className={"flex items-center gap-4"}>
              <p
                className={
                  "text-xs font-semibold text-stone-500 tracking-widest uppercase"
                }
              >
