...
import { StarsBackgroundDemo } from "@/components/StarBackground";
...
export default function Home() {
  return (
    <div className={"bg-black overflow-x-hidden"}>
      ...
      <section
        className={
          "pt-28 sm:pt-32 relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pb-20 overflow-hidden"
        }
      >
        <StarsBackgroundDemo />
        ...
        <div
          className={
            "col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2"
          }
        >
          <Badge variant={"gold"}>Powered by AI - Now in Beta</Badge>
          <h1
            className={
              "font-serif relative text-5xl sm:text-6xl lg:text-7xl tracking-tighter max-w-4xl"
            }
          >
          ...
          <p
            className={
              "relative text-sm sm:text-base md:text-lg text-stone-400 max-w-xl mt-6 leading-relaxed"
            }
          >
            Book 1:1 mock interview with senior engineers from top companies.
          ...
          <div
            className={
              "relative flex justify-center gap-2 sm:gap-4 mt-10 sm:w-auto"
            }
          >
          ...
          <div
            className={
              "relative flex items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-16"
            }
          >
            <div className={"flex"}>
              {AVATARS.map((av, i) => (
        ...
        <div
          className={
            "col-span-full lg:col-span-2 flex items-center justify-center lg:justify-start mt-12 lg:mt-0 lg:rotate-3"
          }
        >
      ...
      <section className={"relative z-10 border-y borderwhite/10 py-14"}>
        <p
          className={
            "text-center text-xs font-medium text-stone-600 tracking-widest uppercase mb-8"
          }
        >
        ...
        <div
          className={"flex flex-wrap items-center justify-center gap-24 px-6"}
        >
          {LOGOS.map((l) => (
            <Image
              src={l.src}
        ...
        <div className={"grid grid-cols-12 gap-4"}>
          <div className={"col-span-12 md:col-span-7"}>
            <BentoCard
              ...
              desc={
                "Interviewers get a live AI co-pilot  generating role-specific " +
                "questions on demand system design, behavioural, DSA, all tailored" +
        ...
        <div className={"grid md:grid-cols-2 gap-6"}>
          {ROLES.map((role) => (
            <div
              key={role.label}
              className={
                "relative bg-[#0f0f11] border border-white/10 hover:border-amber-400/20 rounded-2xl p-12 h-full transition duration-300 overflow-hidden"
              }
            >
              <span
                className={
                  "inline-block text-xs font-semibold text-amber-400 tracking-widest uppercase border border-amber-400/20 bg-amber-400/10 rounded-full px-3 py-1.5 mb-5"
                }
              >
                {role.label}
              </span>
              ...
              <ul>
                {role.perks.map((p) => (
                  <li key={p} className={"flex gap-3 text-sm text-stone-400"}>
                    <span
                      className={
                        "mt-0.5 min-w-4 h-4 rounded-full bg-amber-400/10 border border-amber-400/20 flex items-center justify-center text-xs text-amber-400"
                      }
                    >
                      ✓
                    </span>
      ...
      <section className={"relative z-10 pb-28 max-w-5xl mx-auto px-6"}>
        <div className={"text-center mb-16"}>
          ...
          <SectionHeading
            gray={"Built for both sSimple, transparent"}
      ...
      <section className={"relative z-10 pb-28 max-w-5xl mx-auto px-6"}>
        <div
          className={
            "relative border border-amber-400/20 rounded-3xl px-3 sm:px-16 py-20 bg-linear-to-br from-amber-400/5 text-center overflow-hidden"
          }
        >
          <StarsBackgroundDemo />
          <h2
            className={
              "font-serif relative text-4xl md:text-5xl leading-tight tracking-tight mb-4"
            }
          >
